...
import { LuBatteryWarning, LuBell, LuBellRing, LuBug, LuCalendar, LuCircleCheck, LuCloudUpload, LuDatabaseZap, LuDownload, LuLock, LuMessageCircle, LuServerCrash, LuSquareCheck, LuTriangleAlert, LuUserPlus } from 'react-icons/lu';
      ...
      <Dropdown align="end">
        ...
        <DropdownMenu className="p-0 dropdown-menu-end dropdown-menu-lg">
          <div className="px-3 py-2 border-bottom">
            <Row className="align-items-center">
              ...
              <Col className="text-end">
                <Link href="#" className="badge text-bg-light badge-label py-1">
                  14 Alerts
                </Link>
              </Col>
            </Row>
          ...
          maxHeight: '300px'
            ...
            {notifications.map(notification => <DropdownItem className="notification-item py-2 text-wrap" id={notification.id} key={notification.id}>
          ...
          <Link href="javascript:void(0);" className="dropdown-item text-center text-reset text-decoration-underline link-offset-2 fw-bold notify-item border-top border-light py-2">
            View All Alerts
          </Link>
        </DropdownMenu>
      </Dropdown>
