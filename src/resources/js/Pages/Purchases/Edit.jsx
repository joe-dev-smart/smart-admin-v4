...
export default function PurchasesEdit({ purchase, providers, stores, products }) {
    ...
    return (
        <MainLayout>
            <Head title={t('purchases:editPurchase')} />

            <div className="container-fluid">
                <PageHeader
                    title={t('purchases:editPurchase')}
                    subtitle={`${t('purchases:fields.code')}: ${purchase.code}`}
                    ...
                    breadcrumbs={[
                        ...
                        { label: t('purchases:editPurchase') },
                    ]}
                />
                        ...
                        <Card.Body>
                            <Row>
                                ...
                                <Col md={3} className="mb-3">
                                    <Form.Group>
                                        <Form.Label>{t('purchases:fields.code')}</Form.Label>
                                        <Form.Control
                                            type="text"
                                            value={purchase.code}
                                            readOnly
