...
export default function ProvidersEdit({ provider }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        cellphone_2: provider.cellphone_2 || '',
    ...
    return (
        <MainLayout>
            <Head title={`${t('providers:edit.title')} - ${provider.name}`} />
