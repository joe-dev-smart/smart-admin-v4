...
export default function StoresEdit({ store }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        allow_sales: store.allow_sales || 'enabled',
    ...
    return (
        <MainLayout>
            <Head title={`${t('stores:edit.title')} - ${store.name}`} />

            <div className="container-fluid">
                <PageHeader
                    title={t('stores:edit.title')}
